...
DATASET=Animal3D
python pck_spair_pascal_sphere.py --DATA_PATH /misc/lmbraid21/jesslen/Premnath/dataset --SPH_CKPT_PATH /misc/lmbraid21/jesslen/Premnath/exps_smap/exp_cuda\:0_2024_07_06_14\:48\:29/ckpts/200.pth --ANIMAL3D --ONLY_DINO --SPH
